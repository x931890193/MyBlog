...
from blog.views import blog, bloglist, robots, sitemap, article_like, duanzi_like, tech_radar, dev_tools, sponsor, random_music_api, sponsor_lead_api, sponsor_ad_redirect, sponsor_ad_event_api, tag_landing
